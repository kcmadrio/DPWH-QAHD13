            ...
            <div class="row pb-5 p-3 justify-content-center overflow-hidden">
                <div class="col-md-5 pt-4">
                    <div class="col-md-auto">
                        <label for="validationMaterials" class="form-label">KIND OF MATERIALS</label>
                        <select class="form-select" id="validationMaterials" onchange="selectedMaterial()" required>
                            <option></option>
                            <?php
                            $sql = "Select Distinct kind_of_materials from materials";
                            $result = mysqli_query($connection, $sql);
                            while ($row = mysqli_fetch_array($result)) {
                                ?>

                                <option value="<?php echo $row['kind_of_materials'] ?>"><?php echo $row['kind_of_materials'] ?>
                                </option>
                    ...
                    <div class="col-md-auto pt-2">
                        <label class="form-label" id="noT">NO. OF TEST</label>
                        <input type="number" class="form-control" id="noTest" onchange="selectedMaterial()" required>
                    </div>
                </div>
                <div class="row pt-2">
                        ...
                        <table class="table table-bordered border-dark ">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 30%">NO. OF TEST</th>
                                    <th class="text-center" style="width: 40%">PRICE PER TEST</th>
